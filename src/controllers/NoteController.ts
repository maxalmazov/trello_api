...
const NoteController = (app: core.Express): void => {
  app.get(routes.note.getAll, asyncHandler(async (request: Request, response: Response) => {
    const notes = await Note.find().exec();

    response.send(notes);
  }));

  app.get(routes.note.getOneById, asyncHandler(async (request: Request, response: Response) => {
  ...
  app.post(routes.note.post, asyncHandler(async (request: Request, response: Response) => {
  ...
  app.put(routes.note.put, asyncHandler(async (request: Request, response: Response) => {
    const noteId = request.params.id;
  ...
  app.delete(routes.note.delete, asyncHandler(async (request: Request, response: Response) => {
    const noteId = request.params.id;
